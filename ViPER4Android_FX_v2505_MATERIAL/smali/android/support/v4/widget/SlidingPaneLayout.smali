...
# static fields
.field static final a:Landroid/support/v4/widget/ca;
...
.field private p:Landroid/support/v4/widget/by;

.field private final q:Landroid/support/v4/widget/cz;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/ca;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v1, Landroid/support/v4/widget/bv;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/bv;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/cf;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    invoke-static {p0, v2}, Landroid/support/v4/view/cf;->c(Landroid/view/View;I)V

    new-instance v1, Landroid/support/v4/widget/bx;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/bx;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/support/v4/widget/bu;)V

    invoke-static {p0, v3, v1}, Landroid/support/v4/widget/cz;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/dc;)Landroid/support/v4/widget/cz;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;

    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;

    const/high16 v2, 0x43c80000    # 400.0f

    mul-float/2addr v0, v2

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/cz;->a(F)V
...
.method private a(Landroid/view/View;FI)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/cf;->g(Landroid/view/View;)I
    ...
    invoke-static {p1, v5, v0}, Landroid/support/v4/view/cf;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v4/widget/bw;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method static synthetic b(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/support/v4/widget/cz;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;
...
.method private static f(Landroid/view/View;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->j(Landroid/view/View;)Z
...
.method private g(Landroid/view/View;)V
    ...
    sget-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->a:Landroid/support/v4/widget/ca;

    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/ca;->a(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/by;
    ...
    invoke-interface {v0, p1, v1}, Landroid/support/v4/widget/by;->a(Landroid/view/View;F)V
...
.method a(FI)Z
    ...
    :goto_1
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;
    ...
    invoke-virtual {v2, v3, v0, v4}, Landroid/support/v4/widget/cz;->a(Landroid/view/View;II)Z
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/by;->a(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/by;->b(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/cz;->f()V
...
.method protected onDetachedFromWindow()V
    ...
    check-cast v0, Landroid/support/v4/widget/bw;

    invoke-virtual {v0}, Landroid/support/v4/widget/bw;->run()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;
    ...
    invoke-virtual {v4, v0, v5, v6}, Landroid/support/v4/widget/cz;->b(Landroid/view/View;II)Z
    ...
    :goto_2
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;
    ...
    invoke-virtual {v4, v5, v0, v3}, Landroid/support/v4/widget/cz;->b(Landroid/view/View;II)Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/cz;->a(I)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/cz;->a()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/cz;->f()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->q:Landroid/support/v4/widget/cz;

    invoke-virtual {v5}, Landroid/support/v4/widget/cz;->d()I
    ...
    invoke-virtual {v3, v4, v1, v2}, Landroid/support/v4/widget/cz;->b(Landroid/view/View;II)Z
...
.method public setPanelSlideListener(Landroid/support/v4/widget/by;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->p:Landroid/support/v4/widget/by;
