...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/ay;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/n;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;
    ...
    iget-object v2, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/content/n;->a(ILandroid/support/v4/content/p;)V

    iget-object v0, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/n;->a(Landroid/support/v4/content/o;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/n;->a()V

    goto/16 :goto_0
.end method

.method a(Landroid/support/v4/content/n;Ljava/lang/Object;)V
    .locals 4
    ...
    invoke-static {v1}, Landroid/support/v4/app/az;->a(Landroid/support/v4/app/az;)Landroid/support/v4/app/aa;
    ...
    invoke-static {v0}, Landroid/support/v4/app/az;->a(Landroid/support/v4/app/az;)Landroid/support/v4/app/aa;

    move-result-object v0

    iget-object v0, v0, Landroid/support/v4/app/aa;->d:Landroid/support/v4/app/ad;

    iget-object v0, v0, Landroid/support/v4/app/ad;->v:Ljava/lang/String;
    ...
    iget-object v1, v1, Landroid/support/v4/app/aa;->d:Landroid/support/v4/app/ad;

    const-string v2, "onLoadFinished"

    iput-object v2, v1, Landroid/support/v4/app/ad;->v:Ljava/lang/String;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/content/n;->a(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/ay;->a(Landroid/support/v4/content/n;Ljava/lang/Object;)V
    :try_end_0
    ...
    iput-object v1, v0, Landroid/support/v4/app/ad;->v:Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/support/v4/app/az;->a(Landroid/support/v4/app/az;)Landroid/support/v4/app/aa;
    ...
    iget-object v2, v2, Landroid/support/v4/app/aa;->d:Landroid/support/v4/app/ad;

    iput-object v1, v2, Landroid/support/v4/app/ad;->v:Ljava/lang/String;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/ba;->a(Landroid/support/v4/content/n;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/n;->b(Landroid/support/v4/content/o;)V

    iget-object v0, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;

    invoke-virtual {v0}, Landroid/support/v4/content/n;->c()V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;
    ...
    iput-object v3, v1, Landroid/support/v4/app/ad;->v:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/ba;->d:Landroid/support/v4/content/n;

    invoke-interface {v0, v3}, Landroid/support/v4/app/ay;->a(Landroid/support/v4/content/n;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/n;->e()V
