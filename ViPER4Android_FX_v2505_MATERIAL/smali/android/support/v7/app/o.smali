...
.field private final b:Landroid/support/v7/app/bc;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/app/bc;Landroid/view/Window;)V
    .locals 4
    ...
    iput-object p2, p0, Landroid/support/v7/app/o;->b:Landroid/support/v7/app/bc;

    iput-object p3, p0, Landroid/support/v7/app/o;->c:Landroid/view/Window;

    new-instance v0, Landroid/support/v7/app/aa;

    invoke-direct {v0, p2}, Landroid/support/v7/app/aa;-><init>(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/app/bc;->a(I)Z
...
.method static synthetic a(Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v7/app/o;->b(Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
...
.method private a(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v1}, Landroid/support/v7/app/o;->a(Landroid/view/View;)Z
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/app/o;->c:Landroid/view/Window;
    ...
    sget v2, Landroid/support/v7/a/g;->custom:I
    ...
    iget v1, p0, Landroid/support/v7/app/o;->i:I

    iget v2, p0, Landroid/support/v7/app/o;->j:I

    iget v3, p0, Landroid/support/v7/app/o;->k:I

    iget v4, p0, Landroid/support/v7/app/o;->l:I
...
.method private a(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    sget v2, Landroid/support/v7/a/g;->scrollIndicatorUp:I
    ...
    sget v3, Landroid/support/v7/a/g;->scrollIndicatorDown:I
    ...
    invoke-static {p2, p3, p4}, Landroid/support/v4/view/cf;->a(Landroid/view/View;II)V
    ...
    invoke-direct {v3, p0, v2, v0}, Landroid/support/v7/app/q;-><init>(Landroid/support/v7/app/o;Landroid/view/View;Landroid/view/View;)V

    invoke-virtual {v1, v3}, Landroid/support/v4/widget/NestedScrollView;->setOnScrollChangeListener(Landroid/support/v4/widget/az;)V

    iget-object v1, p0, Landroid/support/v7/app/o;->w:Landroid/support/v4/widget/NestedScrollView;

    new-instance v3, Landroid/support/v7/app/r;

    invoke-direct {v3, p0, v2, v0}, Landroid/support/v7/app/r;-><init>(Landroid/support/v7/app/o;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, p0, v2, v0}, Landroid/support/v7/app/s;-><init>(Landroid/support/v7/app/o;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, p0, v2, v0}, Landroid/support/v7/app/t;-><init>(Landroid/support/v7/app/o;Landroid/view/View;Landroid/view/View;)V
...
.method static a(Landroid/view/View;)Z
    ...
    invoke-static {v3}, Landroid/support/v7/app/o;->a(Landroid/view/View;)Z
...
.method private static b(Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/cf;->b(Landroid/view/View;I)Z
...
.method private b(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/o;->C:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->z:Landroid/widget/ImageView;

    iget-object v0, p0, Landroid/support/v7/app/o;->d:Ljava/lang/CharSequence;
    ...
    sget v1, Landroid/support/v7/a/g;->alertTitle:I
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->A:Landroid/widget/TextView;
    ...
    iget v0, p0, Landroid/support/v7/app/o;->x:I
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/o;->y:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/app/o;->z:Landroid/widget/ImageView;

    invoke-virtual {v3}, Landroid/widget/ImageView;->getPaddingRight()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/app/o;->z:Landroid/widget/ImageView;
...
.method private c()V
    ...
    sget v2, Landroid/support/v7/a/g;->parentPanel:I

    invoke-virtual {v0, v2}, Landroid/view/Window;->findViewById(I)Landroid/view/View;

    move-result-object v0

    sget v2, Landroid/support/v7/a/g;->topPanel:I

    invoke-virtual {v0, v2}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v2

    sget v4, Landroid/support/v7/a/g;->contentPanel:I
    ...
    sget v6, Landroid/support/v7/a/g;->customPanel:I
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/o;->a(Landroid/view/ViewGroup;)V

    sget v6, Landroid/support/v7/a/g;->topPanel:I

    invoke-virtual {v0, v6}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v6

    sget v7, Landroid/support/v7/a/g;->contentPanel:I

    invoke-virtual {v0, v7}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v7

    sget v8, Landroid/support/v7/a/g;->buttonPanel:I

    invoke-virtual {v0, v8}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v8

    invoke-direct {p0, v6, v2}, Landroid/support/v7/app/o;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v2

    invoke-direct {p0, v7, v4}, Landroid/support/v7/app/o;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v6

    invoke-direct {p0, v8, v5}, Landroid/support/v7/app/o;->a(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v4

    invoke-direct {p0, v6}, Landroid/support/v7/app/o;->c(Landroid/view/ViewGroup;)V

    invoke-direct {p0, v4}, Landroid/support/v7/app/o;->d(Landroid/view/ViewGroup;)V

    invoke-direct {p0, v2}, Landroid/support/v7/app/o;->b(Landroid/view/ViewGroup;)V
    ...
    sget v4, Landroid/support/v7/a/g;->textSpacerNoButtons:I
    ...
    iget-object v4, p0, Landroid/support/v7/app/o;->w:Landroid/support/v4/widget/NestedScrollView;
    ...
    invoke-direct {p0, v6, v4, v0, v1}, Landroid/support/v7/app/o;->a(Landroid/view/ViewGroup;Landroid/view/View;II)V
...
.method private c(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->w:Landroid/support/v4/widget/NestedScrollView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->B:Landroid/widget/TextView;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/o;->e:Ljava/lang/CharSequence;
...
.method private d(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->n:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/app/o;->n:Landroid/widget/Button;

    iget-object v1, p0, Landroid/support/v7/app/o;->N:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Landroid/support/v7/app/o;->o:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->q:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/app/o;->q:Landroid/widget/Button;

    iget-object v6, p0, Landroid/support/v7/app/o;->N:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v6}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Landroid/support/v7/app/o;->r:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/app/o;->t:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/app/o;->t:Landroid/widget/Button;

    iget-object v4, p0, Landroid/support/v7/app/o;->N:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v4}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Landroid/support/v7/app/o;->u:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Landroid/support/v7/app/o;->r:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Landroid/support/v7/app/o;->u:Ljava/lang/CharSequence;
...
.method static synthetic g(Landroid/support/v7/app/o;)Landroid/support/v7/app/bc;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/app/o;->b:Landroid/support/v7/app/bc;
...
.method public a()V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/o;->b()I

    move-result v0

    iget-object v1, p0, Landroid/support/v7/app/o;->b:Landroid/support/v7/app/bc;

    invoke-virtual {v1, v0}, Landroid/support/v7/app/bc;->setContentView(I)V

    invoke-direct {p0}, Landroid/support/v7/app/o;->c()V
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v1, p0, Landroid/support/v7/app/o;->x:I
