...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/bz;->a:Landroid/graphics/Rect;
    ...
    sput-object v0, Landroid/support/v7/widget/bz;->b:Ljava/lang/Class;
    :try_end_0
...
.method public static a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    sget-object v0, Landroid/support/v7/widget/bz;->b:Ljava/lang/Class;
    ...
    sget-object v1, Landroid/support/v7/widget/bz;->b:Ljava/lang/Class;
...
.method static b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/bz;->d(Landroid/graphics/drawable/Drawable;)V
...
.method public static c(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v5}, Landroid/support/v7/widget/bz;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_8
    instance-of v0, p0, Landroid/support/v7/b/a/a;

    if-eqz v0, :cond_9

    check-cast p0, Landroid/support/v7/b/a/a;

    invoke-virtual {p0}, Landroid/support/v7/b/a/a;->b()Landroid/graphics/drawable/Drawable;
...
.method private static d(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    sget-object v1, Landroid/support/v7/widget/fs;->e:[I
    ...
    :cond_1
    sget-object v1, Landroid/support/v7/widget/fs;->h:[I
