...
.field private w:Landroid/support/v4/widget/bn;

.field private x:Landroid/support/v4/view/ep;

.field private final y:Landroid/support/v4/view/fg;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/fg;
...
.method static synthetic a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/view/ep;)Landroid/support/v4/view/ep;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/ep;

    return-object p1
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/bm;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/bn;->a(Landroid/content/Context;)Landroid/support/v4/widget/bn;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/bn;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/bn;
...
.method static synthetic b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/view/fg;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/fg;
...
.method private k()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/ep;
...
.method public a(I)V
    ...
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/bm;

    invoke-interface {v0}, Landroid/support/v7/widget/bm;->f()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->g()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/y;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/bm;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/y;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/bm;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/bm;
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->h()Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/view/cf;->p(Landroid/view/View;)F
...
.method public e()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->i()Z
...
.method public f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->j()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->v(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/gm;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public g()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->k()Z
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/cf;->p(Landroid/view/View;)F
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->e()Ljava/lang/CharSequence;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->l()Z
...
.method public i()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bm;->m()V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v2}, Landroid/support/v7/widget/gm;->a(II)I
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bm;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bm;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bm;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bm;->a(Landroid/view/Window$Callback;)V
