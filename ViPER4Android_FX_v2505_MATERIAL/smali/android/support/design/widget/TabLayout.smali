...
.field private c:Landroid/support/design/widget/ce;

.field private final d:Landroid/support/design/widget/cb;
...
.field private u:Landroid/support/design/widget/bz;

.field private v:Landroid/support/design/widget/cp;

.field private w:Landroid/support/v4/view/ViewPager;

.field private x:Landroid/support/v4/view/bo;

.field private y:Landroid/database/DataSetObserver;

.field private z:Landroid/support/design/widget/cf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1}, Landroid/support/design/widget/co;->a(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/design/widget/cb;-><init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/design/widget/TabLayout;->d:Landroid/support/design/widget/cb;

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->d:Landroid/support/design/widget/cb;
    ...
    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->d:Landroid/support/design/widget/cb;
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/cb;->b(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/cb;->a(I)V
...
.method private a(IF)I
    ...
    invoke-virtual {v1, p1}, Landroid/support/design/widget/cb;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    add-int/lit8 v1, p1, 0x1

    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->d:Landroid/support/design/widget/cb;

    invoke-virtual {v2}, Landroid/support/design/widget/cb;->getChildCount()I
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/cb;->getChildAt(I)Landroid/view/View;
...
.method private a(IFZZ)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/cb;->getChildCount()I
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/design/widget/cb;->a(IF)V

    :cond_2
    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    invoke-virtual {v1}, Landroid/support/design/widget/cp;->b()Z
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/cp;->e()V
...
.method private a(Landroid/support/design/widget/TabItem;)V
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout;->a()Landroid/support/design/widget/ce;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ce;->a(Ljava/lang/CharSequence;)Landroid/support/design/widget/ce;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ce;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/design/widget/ce;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ce;->a(I)Landroid/support/design/widget/ce;

    :cond_2
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/design/widget/ce;)V
...
.method private a(Landroid/support/design/widget/ce;I)V
    .locals 3

    invoke-virtual {p1, p2}, Landroid/support/design/widget/ce;->b(I)V
    ...
    check-cast v0, Landroid/support/design/widget/ce;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/ce;->b(I)V
...
.method private a(Landroid/support/v4/view/bo;Z)V
    .locals 2

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->x:Landroid/support/v4/view/bo;
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/design/widget/TabLayout;->x:Landroid/support/v4/view/bo;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/ca;-><init>(Landroid/support/design/widget/TabLayout;Landroid/support/design/widget/by;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/view/bo;->a(Landroid/database/DataSetObserver;)V
...
.method private a(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/cb;->getChildCount()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/cb;->getChildAt(I)Landroid/view/View;
...
.method private c(Landroid/support/design/widget/ce;)Landroid/support/design/widget/cg;
    .locals 2
    ...
    check-cast v0, Landroid/support/design/widget/cg;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/cg;-><init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V

    :cond_0
    invoke-static {v0, p1}, Landroid/support/design/widget/cg;->a(Landroid/support/design/widget/cg;Landroid/support/design/widget/ce;)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/design/widget/cg;->setFocusable(Z)V

    invoke-direct {p0}, Landroid/support/design/widget/TabLayout;->getTabMinWidth()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/support/design/widget/cg;->setMinimumWidth(I)V
...
.method private c()V
    ...
    iget-object v4, p0, Landroid/support/design/widget/TabLayout;->x:Landroid/support/v4/view/bo;

    invoke-virtual {v4, v0}, Landroid/support/v4/view/bo;->c(I)Ljava/lang/CharSequence;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/design/widget/ce;->a(Ljava/lang/CharSequence;)Landroid/support/design/widget/ce;

    move-result-object v3

    invoke-virtual {p0, v3, v1}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/design/widget/ce;Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout;->a(I)Landroid/support/design/widget/ce;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout;->b(Landroid/support/design/widget/ce;)V
...
.method private c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/cb;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {v1, p1}, Landroid/support/design/widget/cb;->removeViewAt(I)V

    if-eqz v0, :cond_0

    invoke-static {v0}, Landroid/support/design/widget/cg;->a(Landroid/support/design/widget/cg;)V
...
.method private c(Landroid/support/design/widget/ce;Z)V
    .locals 3

    invoke-static {p1}, Landroid/support/design/widget/ce;->d(Landroid/support/design/widget/ce;)Landroid/support/design/widget/cg;
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/design/widget/cb;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    if-eqz p2, :cond_0

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/design/widget/cg;->setSelected(Z)V
...
.method private d()V
    ...
    invoke-static {v0}, Landroid/support/design/widget/ce;->c(Landroid/support/design/widget/ce;)V
...
.method private d(I)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->F(Landroid/view/View;)Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/cb;->a()Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    if-nez v2, :cond_3

    invoke-static {}, Landroid/support/design/widget/dl;->a()Landroid/support/design/widget/cp;

    move-result-object v2

    iput-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    sget-object v3, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, v3}, Landroid/support/design/widget/cp;->a(Landroid/view/animation/Interpolator;)V

    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    invoke-virtual {v2, v4}, Landroid/support/design/widget/cp;->a(I)V

    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    new-instance v3, Landroid/support/design/widget/by;

    invoke-direct {v3, p0}, Landroid/support/design/widget/by;-><init>(Landroid/support/design/widget/TabLayout;)V

    invoke-virtual {v2, v3}, Landroid/support/design/widget/cp;->a(Landroid/support/design/widget/cu;)V

    :cond_3
    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;

    invoke-virtual {v2, v0, v1}, Landroid/support/design/widget/cp;->a(II)V

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->v:Landroid/support/design/widget/cp;
    ...
    invoke-virtual {v0, p1, v4}, Landroid/support/design/widget/cb;->a(II)V
...
.method private f()V
    ...
    invoke-static {v2, v0, v1, v1, v1}, Landroid/support/v4/view/cf;->b(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/design/widget/cb;->setGravity(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/cb;->setGravity(I)V
...
.method private getDefaultHeight()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ce;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-eqz v4, :cond_0

    invoke-virtual {v0}, Landroid/support/design/widget/ce;->d()Ljava/lang/CharSequence;
...
.method private getScrollPosition()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/cb;->b()F
...
.method private getTabScrollRange()I
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/cb;->getWidth()I
...
.method private setSelectedTabView(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/design/widget/cb;->getChildAt(I)Landroid/view/View;
...
.method public a()Landroid/support/design/widget/ce;
    ...
    invoke-direct {v0, v1}, Landroid/support/design/widget/ce;-><init>(Landroid/support/design/widget/by;)V

    :cond_0
    invoke-static {v0, p0}, Landroid/support/design/widget/ce;->a(Landroid/support/design/widget/ce;Landroid/support/design/widget/TabLayout;)Landroid/support/design/widget/TabLayout;

    invoke-direct {p0, v0}, Landroid/support/design/widget/TabLayout;->c(Landroid/support/design/widget/ce;)Landroid/support/design/widget/cg;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/design/widget/ce;->a(Landroid/support/design/widget/ce;Landroid/support/design/widget/cg;)Landroid/support/design/widget/cg;
...
.method public a(Landroid/support/design/widget/ce;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/design/widget/ce;Z)V

    return-void
.end method

.method public a(Landroid/support/design/widget/ce;Z)V
    .locals 2

    invoke-static {p1}, Landroid/support/design/widget/ce;->a(Landroid/support/design/widget/ce;)Landroid/support/design/widget/TabLayout;
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/TabLayout;->c(Landroid/support/design/widget/ce;Z)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/design/widget/ce;I)V

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Landroid/support/design/widget/ce;->e()V
...
.method public b()V
    ...
    invoke-static {v0}, Landroid/support/design/widget/ce;->b(Landroid/support/design/widget/ce;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;

    return-void
.end method

.method b(Landroid/support/design/widget/ce;)V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, v0}, Landroid/support/design/widget/TabLayout;->b(Landroid/support/design/widget/ce;Z)V

    return-void
.end method

.method b(Landroid/support/design/widget/ce;Z)V
    .locals 3

    const/4 v1, -0x1

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;
    ...
    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->u:Landroid/support/design/widget/bz;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->u:Landroid/support/design/widget/bz;

    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;

    invoke-interface {v0, v1}, Landroid/support/design/widget/bz;->c(Landroid/support/design/widget/ce;)V
    ...
    :cond_3
    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;

    if-eqz v2, :cond_4

    iget-object v2, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;

    invoke-virtual {v2}, Landroid/support/design/widget/ce;->c()I
    ...
    invoke-interface {v0, v1}, Landroid/support/design/widget/bz;->b(Landroid/support/design/widget/ce;)V

    :cond_6
    iput-object p1, p0, Landroid/support/design/widget/TabLayout;->c:Landroid/support/design/widget/ce;
    ...
    invoke-interface {v0, v1}, Landroid/support/design/widget/bz;->a(Landroid/support/design/widget/ce;)V
...
.method public getSelectedTabPosition()I
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ce;->c()I
...
.method public setOnTabSelectedListener(Landroid/support/design/widget/bz;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/TabLayout;->u:Landroid/support/design/widget/bz;
...
.method public setSelectedTabIndicatorHeight(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/cb;->b(I)V
...
.method public setTabsFromPagerAdapter(Landroid/support/v4/view/bo;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/v4/view/bo;Z)V
...
.method public setupWithViewPager(Landroid/support/v4/view/ViewPager;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->z:Landroid/support/design/widget/cf;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/TabLayout;->w:Landroid/support/v4/view/ViewPager;

    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->z:Landroid/support/design/widget/cf;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->b(Landroid/support/v4/view/ed;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/design/widget/cf;-><init>(Landroid/support/design/widget/TabLayout;)V

    iput-object v1, p0, Landroid/support/design/widget/TabLayout;->z:Landroid/support/design/widget/cf;

    :cond_2
    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->z:Landroid/support/design/widget/cf;

    invoke-static {v1}, Landroid/support/design/widget/cf;->a(Landroid/support/design/widget/cf;)V

    iget-object v1, p0, Landroid/support/design/widget/TabLayout;->z:Landroid/support/design/widget/cf;

    invoke-virtual {p1, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/ed;)V

    new-instance v1, Landroid/support/design/widget/ch;

    invoke-direct {v1, p1}, Landroid/support/design/widget/ch;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-virtual {p0, v1}, Landroid/support/design/widget/TabLayout;->setOnTabSelectedListener(Landroid/support/design/widget/bz;)V

    invoke-direct {p0, v0, v3}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/v4/view/bo;Z)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/TabLayout;->setOnTabSelectedListener(Landroid/support/design/widget/bz;)V

    invoke-direct {p0, v2, v3}, Landroid/support/design/widget/TabLayout;->a(Landroid/support/v4/view/bo;Z)V
