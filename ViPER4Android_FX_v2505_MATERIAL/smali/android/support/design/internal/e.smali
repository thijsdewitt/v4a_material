...
.method constructor <init>(Landroid/support/design/internal/b;)V
    ...
    iput-object p1, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/internal/e;->b:Ljava/util/ArrayList;

    invoke-direct {p0}, Landroid/support/design/internal/e;->f()V
...
.method private a(II)V
    ...
    iget-object v0, p0, Landroid/support/design/internal/e;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/i;->a()Landroid/support/v7/view/menu/m;
    ...
    iget-object v1, p0, Landroid/support/design/internal/e;->d:Landroid/graphics/drawable/ColorDrawable;
    ...
    iput-object v1, p0, Landroid/support/design/internal/e;->d:Landroid/graphics/drawable/ColorDrawable;
...
.method private f()V
    ...
    iget-boolean v0, p0, Landroid/support/design/internal/e;->e:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/e;->e:Z
    ...
    invoke-direct {v1, v2}, Landroid/support/design/internal/f;-><init>(Landroid/support/design/internal/c;)V
    ...
    iget-object v1, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;
    ...
    iget-object v0, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;

    invoke-static {v0}, Landroid/support/design/internal/b;->a(Landroid/support/design/internal/b;)Landroid/support/v7/view/menu/i;
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/internal/e;->a(Landroid/support/v7/view/menu/m;)V
    ...
    iget-object v1, p0, Landroid/support/design/internal/e;->b:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/design/internal/h;

    iget-object v6, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;
    ...
    invoke-direct {v2, v6, v10}, Landroid/support/design/internal/h;-><init>(II)V
    ...
    invoke-direct {v2, v0, v6}, Landroid/support/design/internal/i;-><init>(Landroid/support/v7/view/menu/m;Landroid/support/design/internal/c;)V
    ...
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/e;->b:Ljava/util/ArrayList;

    new-instance v13, Landroid/support/design/internal/i;

    const/4 v14, 0x0

    invoke-direct {v13, v1, v14}, Landroid/support/design/internal/i;-><init>(Landroid/support/v7/view/menu/m;Landroid/support/design/internal/c;)V
    ...
    invoke-direct {p0, v10, v0}, Landroid/support/design/internal/e;->a(II)V
    ...
    iget-object v5, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;

    invoke-static {v5}, Landroid/support/design/internal/b;->k(Landroid/support/design/internal/b;)I

    move-result v5

    iget-object v9, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;

    invoke-static {v9}, Landroid/support/design/internal/b;->k(Landroid/support/design/internal/b;)I

    move-result v9

    invoke-direct {v2, v5, v9}, Landroid/support/design/internal/h;-><init>(II)V
    ...
    :cond_b
    iget-object v3, p0, Landroid/support/design/internal/e;->b:Ljava/util/ArrayList;

    new-instance v4, Landroid/support/design/internal/i;

    const/4 v5, 0x0

    invoke-direct {v4, v0, v5}, Landroid/support/design/internal/i;-><init>(Landroid/support/v7/view/menu/m;Landroid/support/design/internal/c;)V
    ...
    invoke-direct {p0, v4, v1}, Landroid/support/design/internal/e;->a(II)V
...
.method public a(Landroid/view/ViewGroup;I)Landroid/support/design/internal/m;
    .locals 3
    ...
    :pswitch_0
    new-instance v0, Landroid/support/design/internal/j;
    ...
    iget-object v2, p0, Landroid/support/design/internal/e;->a:Landroid/support/design/internal/b;
    ...
    invoke-direct {v0, v1, p1, v2}, Landroid/support/design/internal/j;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View$OnClickListener;)V
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/design/internal/k;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, v1}, Landroid/support/design/internal/d;-><init>(Landroid/view/View;)V
...
.method public a(Landroid/os/Bundle;)V
    ...
    instance-of v3, v0, Landroid/support/design/internal/i;
    ...
    :cond_1
    iput-boolean v4, p0, Landroid/support/design/internal/e;->e:Z
...
.method public a(Landroid/support/design/internal/m;)V
    .locals 1

    instance-of v0, p1, Landroid/support/design/internal/j;

    if-eqz v0, :cond_0

    iget-object v0, p1, Landroid/support/design/internal/m;->a:Landroid/view/View;
...
.method public a(Landroid/support/design/internal/m;I)V
    .locals 4

    const/4 v3, 0x0

    invoke-virtual {p0, p2}, Landroid/support/design/internal/e;->b(I)I
    ...
    check-cast v1, Landroid/support/design/internal/i;

    invoke-virtual {v1}, Landroid/support/design/internal/i;->a()Landroid/support/v7/view/menu/m;
    ...
    iget-object v1, p1, Landroid/support/design/internal/m;->a:Landroid/view/View;

    invoke-virtual {v0}, Landroid/support/design/internal/h;->a()I

    move-result v2

    invoke-virtual {v0}, Landroid/support/design/internal/h;->b()I
...
.method public a(Landroid/support/v7/view/menu/m;)V
    ...
    iget-object v0, p0, Landroid/support/design/internal/e;->c:Landroid/support/v7/view/menu/m;
    ...
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/e;->c:Landroid/support/v7/view/menu/m;
...
.method public bridge synthetic a(Landroid/support/v7/widget/eg;)V
    .locals 0

    check-cast p1, Landroid/support/design/internal/m;

    invoke-virtual {p0, p1}, Landroid/support/design/internal/e;->a(Landroid/support/design/internal/m;)V
...
.method public bridge synthetic a(Landroid/support/v7/widget/eg;I)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/design/internal/e;->a(Landroid/support/design/internal/m;I)V
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/internal/e;->e:Z
...
.method public b(I)I
    ...
    :cond_0
    instance-of v1, v0, Landroid/support/design/internal/f;
...
.method public synthetic b(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/eg;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/design/internal/e;->a(Landroid/view/ViewGroup;I)Landroid/support/design/internal/m;
...
.method public b()V
    ...
    invoke-virtual {p0}, Landroid/support/design/internal/e;->e()V
...
.method public c()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Landroid/support/design/internal/e;->c:Landroid/support/v7/view/menu/m;
    ...
    instance-of v4, v0, Landroid/support/design/internal/i;
