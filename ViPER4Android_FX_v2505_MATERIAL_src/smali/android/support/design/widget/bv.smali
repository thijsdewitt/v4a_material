...
.method constructor <init>(Landroid/support/design/widget/SwipeDismissBehavior;)V
    ...
    iput v0, p0, Landroid/support/design/widget/bv;->c:I
...
.method private a(Landroid/view/View;F)Z
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/design/widget/bv;->a:Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    iget v3, p0, Landroid/support/design/widget/bv;->b:I
    ...
    iget-object v4, p0, Landroid/support/design/widget/bv;->a:Landroid/support/design/widget/SwipeDismissBehavior;
...
.method public a(I)V
    ...
    invoke-static {v0}, Landroid/support/design/widget/SwipeDismissBehavior;->a(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/design/widget/bw;
    ...
    invoke-interface {v0, p1}, Landroid/support/design/widget/bw;->a(I)V
...
.method public a(Landroid/view/View;FF)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/bv;->a(Landroid/view/View;F)Z
    ...
    iget v2, p0, Landroid/support/design/widget/bv;->b:I

    if-ge v0, v2, :cond_1

    iget v0, p0, Landroid/support/design/widget/bv;->b:I
    ...
    :goto_1
    iget-object v2, p0, Landroid/support/design/widget/bv;->a:Landroid/support/design/widget/SwipeDismissBehavior;

    invoke-static {v2}, Landroid/support/design/widget/SwipeDismissBehavior;->b(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/v4/widget/cz;
    ...
    invoke-direct {v1, v2, p1, v0}, Landroid/support/design/widget/bx;-><init>(Landroid/support/design/widget/SwipeDismissBehavior;Landroid/view/View;Z)V

    invoke-static {p1, v1}, Landroid/support/v4/view/cf;->a(Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    :cond_2
    iget v1, p0, Landroid/support/design/widget/bv;->b:I
    ...
    invoke-interface {v0, p1}, Landroid/support/design/widget/bw;->a(Landroid/view/View;)V
...
.method public a(Landroid/view/View;IIII)V
    ...
    invoke-static {p1, v4}, Landroid/support/v4/view/cf;->c(Landroid/view/View;F)V
    ...
    invoke-static {p1, v5}, Landroid/support/v4/view/cf;->c(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;I)Z
    ...
    iget v0, p0, Landroid/support/design/widget/bv;->c:I
...
.method public b(Landroid/view/View;I)V
    ...
    iput p2, p0, Landroid/support/design/widget/bv;->c:I

    invoke-virtual {p1}, Landroid/view/View;->getLeft()I

    move-result v0

    iput v0, p0, Landroid/support/design/widget/bv;->b:I
