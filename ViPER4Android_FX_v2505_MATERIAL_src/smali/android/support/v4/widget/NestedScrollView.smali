...
# static fields
.field private static final v:Landroid/support/v4/widget/ay;

.field private static final w:[I


# instance fields
.field private A:Landroid/support/v4/widget/az;

.field private a:J

.field private final b:Landroid/graphics/Rect;

.field private c:Landroid/support/v4/widget/bn;

.field private d:Landroid/support/v4/widget/ai;

.field private e:Landroid/support/v4/widget/ai;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/ay;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/v4/widget/NestedScrollView;->v:Landroid/support/v4/widget/ay;
...
.method private a()V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;
...
.method private f()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ai;
...
.method private g()V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;

    new-instance v1, Landroid/support/v4/widget/ai;

    invoke-direct {v1, v0}, Landroid/support/v4/widget/ai;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ai;
    ...
    :cond_1
    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;

    iput-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ai;
...
.method public final a(II)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getScrollX()I

    move-result v3

    invoke-virtual {v2, v3, v1, v4, v0}, Landroid/support/v4/widget/bn;->a(IIII)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;
...
.method a(IIIIIIIIZ)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/widget/bn;->a(IIIIII)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bn;->g()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bn;->b()I

    move-result v1

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;

    invoke-virtual {v2}, Landroid/support/v4/widget/bn;->c()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bn;->f()F
...
.method public d(I)V
    ...
    invoke-virtual/range {v0 .. v10}, Landroid/support/v4/widget/bn;->a(IIIIIIIIII)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;

    invoke-virtual {p0}, Landroid/support/v4/widget/NestedScrollView;->getHeight()I

    move-result v4

    invoke-virtual {v3, v2, v4}, Landroid/support/v4/widget/ai;->a(II)V

    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ai;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/widget/ai;->a(II)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bn;->a()Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/bn;->a(IIIIII)Z
...
.method protected onScrollChanged(IIII)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/az;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/widget/az;->a(Landroid/support/v4/widget/NestedScrollView;IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->c:Landroid/support/v4/widget/bn;

    invoke-virtual {v2}, Landroid/support/v4/widget/bn;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bn;->h()V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cf;->a(Landroid/view/View;)I
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->d:Landroid/support/v4/widget/ai;
    ...
    iget-object v2, v0, Landroid/support/v4/widget/NestedScrollView;->e:Landroid/support/v4/widget/ai;

    invoke-virtual {v2}, Landroid/support/v4/widget/ai;->a()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ai;->c()Z
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cf;->d(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/ca;->b(Landroid/view/VelocityTracker;I)F
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v4/widget/bn;->a(IIIIII)Z
...
.method public setOnScrollChangeListener(Landroid/support/v4/widget/az;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->A:Landroid/support/v4/widget/az;
