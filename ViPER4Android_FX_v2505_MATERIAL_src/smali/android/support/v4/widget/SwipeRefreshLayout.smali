...
.field private e:Landroid/support/v4/widget/cm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/ce;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->N:Landroid/view/animation/Animation$AnimationListener;

    new-instance v0, Landroid/support/v4/widget/cj;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/cj;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/ck;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/view/cf;->a(Landroid/view/ViewGroup;Z)V
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    :cond_0
    new-instance v1, Landroid/support/v4/widget/ch;

    invoke-direct {v1, p0, p1, p2}, Landroid/support/v4/widget/ch;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V
...
.method private a(F)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;
    ...
    invoke-static {v1, v10}, Landroid/support/v4/view/cf;->e(Landroid/view/View;F)V

    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;

    invoke-static {v1, v10}, Landroid/support/v4/view/cf;->f(Landroid/view/View;F)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;

    invoke-virtual {v1}, Landroid/support/v4/widget/at;->getAlpha()I
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;

    invoke-static {v13, v1}, Ljava/lang/Math;->min(FF)F

    move-result v1

    invoke-virtual {v4, v12, v1}, Landroid/support/v4/widget/at;->a(FF)V
    ...
    invoke-virtual {v1, v4}, Landroid/support/v4/widget/at;->a(F)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/at;->b(F)V
...
.method private a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/cf;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method static synthetic b(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/at;
    .locals 1
...
.method private b()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/at;->stop()V
...
.method private b(F)V
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/v4/widget/at;->a(FF)V
    ...
    new-instance v0, Landroid/support/v4/widget/ci;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/ci;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method private b(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/cg;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method private c()V
    ...
    invoke-direct {v0, v1, p0}, Landroid/support/v4/widget/at;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->C:Landroid/support/v4/widget/at;

    invoke-virtual {v0, v3}, Landroid/support/v4/widget/at;->b(I)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/at;->getAlpha()I
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/cl;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/cf;->t(Landroid/view/View;)F
...
.method static synthetic d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/cm;
    .locals 1

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/cm;
...
.method private setAnimationProgress(F)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/view/cf;->e(Landroid/view/View;F)V

    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->z:Landroid/support/v4/widget/e;

    invoke-static {v0, p1}, Landroid/support/v4/view/cf;->f(Landroid/view/View;F)V
...
.method private setColorViewAlpha(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/at;->setAlpha(I)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/cf;->D(Landroid/view/View;)Z
...
.method public setOnRefreshListener(Landroid/support/v4/widget/cm;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Landroid/support/v4/widget/cm;
...
.method public setProgressBackgroundColorSchemeColor(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/at;->b(I)V
