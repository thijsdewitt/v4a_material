...
.method public constructor <init>(Landroid/app/FragmentManager;)V
    ...
    iput-object v0, p0, Landroid/support/v13/app/i;->b:Landroid/app/FragmentTransaction;

    iput-object v0, p0, Landroid/support/v13/app/i;->c:Landroid/app/Fragment;

    iput-object p1, p0, Landroid/support/v13/app/i;->a:Landroid/app/FragmentManager;
...
.method public a(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroid/support/v13/app/i;->b:Landroid/app/FragmentTransaction;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v13/app/i;->a:Landroid/app/FragmentManager;
    ...
    :cond_0
    invoke-virtual {p0, p2}, Landroid/support/v13/app/i;->b(I)J
    ...
    invoke-static {v0, v2, v3}, Landroid/support/v13/app/i;->a(IJ)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v13/app/i;->a:Landroid/app/FragmentManager;
    ...
    iget-object v1, p0, Landroid/support/v13/app/i;->b:Landroid/app/FragmentTransaction;

    invoke-virtual {v1, v0}, Landroid/app/FragmentTransaction;->attach(Landroid/app/Fragment;)Landroid/app/FragmentTransaction;

    :goto_0
    iget-object v1, p0, Landroid/support/v13/app/i;->c:Landroid/app/Fragment;
    ...
    invoke-static {v5, v2, v3}, Landroid/support/v13/app/i;->a(IJ)Ljava/lang/String;
...
.method public b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v13/app/i;->c:Landroid/app/Fragment;
    ...
    :cond_1
    iput-object p3, p0, Landroid/support/v13/app/i;->c:Landroid/app/Fragment;
