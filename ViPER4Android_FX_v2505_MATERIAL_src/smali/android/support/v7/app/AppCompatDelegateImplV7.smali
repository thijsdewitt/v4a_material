...
.field private K:Landroid/support/v7/app/bd;
...
.field q:Landroid/support/v4/view/ep;

.field private r:Landroid/support/v7/widget/bl;

.field private s:Landroid/support/v7/app/aw;

.field private t:Landroid/support/v7/app/bb;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/ae;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/app/ag;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/ae;)V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->q:Landroid/support/v4/view/ep;

    new-instance v0, Landroid/support/v7/app/ap;

    invoke-direct {v0, p0}, Landroid/support/v7/app/ap;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V
...
.method private a(Landroid/view/Menu;)Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    ...
    iget-object v4, v1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private a(ILandroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/Menu;)V
    ...
    iget-object p3, p2, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    iget-object v5, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    invoke-interface {v0}, Landroid/support/v7/widget/bl;->e()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;

    invoke-direct {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->b(Landroid/support/v7/view/menu/i;)V
...
.method static synthetic a(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/view/menu/i;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/app/AppCompatDelegateImplV7;->b(Landroid/support/v7/view/menu/i;)V
...
.method private a(Landroid/support/v7/view/menu/i;Z)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bl;->d()Z
    ...
    invoke-static {v0}, Landroid/support/v4/view/df;->b(Landroid/view/ViewConfiguration;)Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bl;->f()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    invoke-interface {v1}, Landroid/support/v7/widget/bl;->e()Z
    ...
    iget-object v2, v1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
    ...
    iget-object v3, v1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
    ...
    iget-object v1, v1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;

    invoke-interface {v0, v5, v1}, Landroid/view/Window$Callback;->onMenuOpened(ILandroid/view/Menu;)Z

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    invoke-interface {v0}, Landroid/support/v7/widget/bl;->g()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/bl;->h()Z
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/app/az;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/content/Context;)V
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
    ...
    :cond_2
    iget-object v1, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private b(Landroid/support/v7/view/menu/i;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bl;->j()V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->a(Landroid/support/v7/view/menu/i;)V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;

    invoke-interface {v4}, Landroid/support/v7/widget/bl;->i()V
    ...
    instance-of v4, v4, Landroid/support/v7/app/bo;

    if-nez v4, :cond_12

    :cond_7
    iget-object v4, p1, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->s:Landroid/support/v7/app/aw;

    if-nez v4, :cond_a

    new-instance v4, Landroid/support/v7/app/aw;

    invoke-direct {v4, p0, v7}, Landroid/support/v7/app/aw;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/app/ap;)V

    iput-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->s:Landroid/support/v7/app/aw;
    ...
    iget-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->s:Landroid/support/v7/app/aw;

    invoke-interface {v4, v5, v6}, Landroid/support/v7/widget/bl;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/y;)V
    ...
    invoke-virtual {p1, v7}, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->a(Landroid/support/v7/view/menu/i;)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->s:Landroid/support/v7/app/aw;

    invoke-interface {v0, v7, v1}, Landroid/support/v7/widget/bl;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/y;)V
...
.method private c(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->t:Landroid/support/v7/app/bb;
    ...
    invoke-direct {v0, p0, v3}, Landroid/support/v7/app/bb;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/app/ap;)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->t:Landroid/support/v7/app/bb;

    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->t:Landroid/support/v7/app/bb;

    invoke-virtual {p1, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->a(Landroid/support/v7/view/menu/y;)Landroid/support/v7/view/menu/z;
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/bl;->h()Z
...
.method private f(I)V
    ...
    iget-object v1, v0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
    ...
    iget-object v2, v0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private g(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/widget/gm;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method private t()V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->u()Landroid/view/ViewGroup;
    ...
    iget-object v0, v0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/i;
...
.method private u()Landroid/view/ViewGroup;
    ...
    sget-object v1, Landroid/support/v7/a/l;->AppCompatTheme:[I

    invoke-virtual {v0, v1}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/v7/a/l;->AppCompatTheme_windowActionBar:I
    ...
    :cond_0
    sget v1, Landroid/support/v7/a/l;->AppCompatTheme_windowNoTitle:I
    ...
    :cond_1
    :goto_0
    sget v1, Landroid/support/v7/a/l;->AppCompatTheme_windowActionBarOverlay:I
    ...
    :cond_2
    sget v1, Landroid/support/v7/a/l;->AppCompatTheme_windowActionModeOverlay:I
    ...
    :cond_3
    sget v1, Landroid/support/v7/a/l;->AppCompatTheme_android_windowIsFloating:I
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->r:Landroid/support/v7/widget/bl;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/bl;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v6}, Landroid/support/v7/widget/bl;->a(I)V
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/bl;->a(I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/app/aq;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V

    invoke-static {v1, v0}, Landroid/support/v4/view/cf;->a(Landroid/view/View;Landroid/support/v4/view/bn;)V
    ...
    new-instance v2, Landroid/support/v7/app/ar;

    invoke-direct {v2, p0}, Landroid/support/v7/app/ar;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V

    invoke-interface {v0, v2}, Landroid/support/v7/widget/ca;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/cb;)V
    ...
    :cond_e
    invoke-static {v2}, Landroid/support/v7/widget/gm;->b(Landroid/view/View;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/app/as;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ContentFrameLayout;->setAttachListener(Landroid/support/v7/widget/bk;)V
...
.method private v()V
    ...
    sget-object v2, Landroid/support/v7/a/l;->AppCompatTheme:[I

    invoke-virtual {v1, v2}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowMinWidthMajor:I
    ...
    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowMinWidthMinor:I
    ...
    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowFixedWidthMajor:I
    ...
    :cond_0
    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowFixedWidthMinor:I
    ...
    :cond_1
    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowFixedHeightMajor:I
    ...
    :cond_2
    sget v2, Landroid/support/v7/a/l;->AppCompatTheme_windowFixedHeightMinor:I
...
.method private w()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->q:Landroid/support/v4/view/ep;
...
.method a(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;
    ...
    :cond_0
    new-instance v4, Landroid/support/v7/app/ax;

    invoke-direct {v4, p0, p1}, Landroid/support/v7/app/ax;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/view/c;)V

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->e:Landroid/support/v7/app/ae;
    ...
    invoke-interface {v0, v4}, Landroid/support/v7/app/ae;->a(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;
    :try_end_0
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;

    invoke-interface {v0, v1}, Landroid/support/v7/app/ae;->a(Landroid/support/v7/view/b;)V
    ...
    invoke-static {v6, v7}, Landroid/support/v4/widget/bb;->a(Landroid/widget/PopupWindow;I)V
    ...
    iput-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/app/av;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;)V
    ...
    :cond_8
    iput-object v3, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/bb;->b(Landroid/app/Activity;)Ljava/lang/String;
...
.method public a(Landroid/support/v7/view/menu/i;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->a(Landroid/support/v7/view/menu/i;Z)V
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    instance-of v1, v0, Landroid/support/v7/app/bz;
    ...
    invoke-direct {v1, p1, v0, v2}, Landroid/support/v7/app/bo;-><init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V

    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->f:Landroid/support/v7/app/ActionBar;

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->b:Landroid/view/Window;

    invoke-virtual {v1}, Landroid/support/v7/app/bo;->i()Landroid/view/Window$Callback;
...
.method public b(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/app/ax;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/view/c;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/app/ActionBar;->a(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->e:Landroid/support/v7/app/ae;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->e:Landroid/support/v7/app/ae;

    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->m:Landroid/support/v7/view/b;

    invoke-interface {v1, v2}, Landroid/support/v7/app/ae;->a(Landroid/support/v7/view/b;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->a(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;
...
.method b(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bl;->setWindowTitle(Ljava/lang/CharSequence;)V
...
.method public c(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->K:Landroid/support/v7/app/bd;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/app/bd;

    invoke-direct {v0}, Landroid/support/v7/app/bd;-><init>()V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->K:Landroid/support/v7/app/bd;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v7/app/bd;->a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
...
.method public f()V
    ...
    invoke-super {p0}, Landroid/support/v7/app/ag;->f()V
...
.method public l()V
    ...
    new-instance v1, Landroid/support/v7/app/bz;
    ...
    invoke-direct {v1, v0, v2}, Landroid/support/v7/app/bz;-><init>(Landroid/app/Activity;Z)V
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/app/bz;-><init>(Landroid/app/Dialog;)V
...
.method s()Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/ActionBar;->f()Z
