...
.field private g:Landroid/support/v7/widget/cn;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/fx;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/fx;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/ap;

    new-instance v0, Landroid/support/v7/widget/an;

    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->d:Landroid/support/v7/widget/ap;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/an;-><init>(Landroid/view/View;Landroid/support/v7/widget/ap;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->e:Landroid/support/v7/widget/an;
    ...
    invoke-direct {v0, p0, v2, p2, p3}, Landroid/support/v7/widget/bb;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->f:Landroid/content/Context;

    sget-object v5, Landroid/support/v7/a/l;->Spinner:[I

    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/fx;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/fx;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/fx;->f(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/fx;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bb;->a(Landroid/graphics/drawable/Drawable;)V

    sget v5, Landroid/support/v7/a/l;->Spinner_android_prompt:I

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/fx;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/bb;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Landroid/support/v7/widget/fx;->a()V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/bb;

    new-instance v2, Landroid/support/v7/widget/az;

    invoke-direct {v2, p0, p0, v0}, Landroid/support/v7/widget/az;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/bb;)V

    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/cn;

    :cond_2
    sget v0, Landroid/support/v7/a/l;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/fx;->e(I)[Ljava/lang/CharSequence;
    ...
    sget v0, Landroid/support/v7/a/i;->support_simple_spinner_dropdown_item:I
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/fx;->a()V
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->e:Landroid/support/v7/widget/an;
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/fx;->g(II)I
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/support/v7/widget/bb;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/bb;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bb;->d()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/bb;->a()Ljava/lang/CharSequence;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/cn;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/cn;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/cn;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/bb;

    new-instance v2, Landroid/support/v7/widget/ba;

    invoke-virtual {v0}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object v0

    invoke-direct {v2, p1, v0}, Landroid/support/v7/widget/ba;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bb;->a(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bb;->b(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bb;->c(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bb;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/bb;->a(Ljava/lang/CharSequence;)V
