...
.field private C:Landroid/support/v7/widget/fr;

.field private final D:Landroid/graphics/Rect;

.field private final E:Landroid/support/v7/widget/ap;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Landroid/support/v7/a/b;->switchStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/v7/a/l;->SwitchCompat:[I

    invoke-static {p1, p2, v0, p3, v2}, Landroid/support/v7/widget/fx;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/fx;

    move-result-object v0

    sget v1, Landroid/support/v7/a/l;->SwitchCompat_android_thumb:I
    ...
    :cond_0
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_track:I
    ...
    :cond_1
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_android_textOn:I
    ...
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_android_textOff:I
    ...
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_showText:I

    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/fx;->a(IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/widget/SwitchCompat;->i:Z

    sget v1, Landroid/support/v7/a/l;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/fx;->e(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/SwitchCompat;->c:I

    sget v1, Landroid/support/v7/a/l;->SwitchCompat_switchMinWidth:I
    ...
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_switchPadding:I
    ...
    sget v1, Landroid/support/v7/a/l;->SwitchCompat_splitTrack:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/fx;->a(IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/widget/SwitchCompat;->f:Z

    sget v1, Landroid/support/v7/a/l;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/fx;->g(II)I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/support/v7/widget/ap;
...
.method static synthetic a(Landroid/support/v7/widget/SwitchCompat;)Landroid/support/v7/widget/fr;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/widget/SwitchCompat;Landroid/support/v7/widget/fr;)Landroid/support/v7/widget/fr;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;
...
.method private a()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;
...
.method private a(Z)V
    ...
    invoke-direct {v1, p0, v2, v0, v3}, Landroid/support/v7/widget/fr;-><init>(Landroid/support/v7/widget/SwitchCompat;FFLandroid/support/v7/widget/fq;)V

    iput-object v1, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;

    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;

    const-wide/16 v2, 0xfa

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/widget/fr;->setDuration(J)V

    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->C:Landroid/support/v7/widget/fr;

    new-instance v1, Landroid/support/v7/widget/fq;

    invoke-direct {v1, p0, p1}, Landroid/support/v7/widget/fq;-><init>(Landroid/support/v7/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fr;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/bz;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Landroid/support/v7/widget/bz;->a:Landroid/graphics/Rect;
...
.method public a(Landroid/content/Context;I)V
    ...
    sget v1, Landroid/support/v7/a/l;->TextAppearance_android_textColor:I
    ...
    :cond_0
    sget v1, Landroid/support/v7/a/l;->TextAppearance_android_typeface:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    sget v2, Landroid/support/v7/a/l;->TextAppearance_android_textStyle:I
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/d/a;-><init>(Landroid/content/Context;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroid/support/v7/widget/bz;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/bz;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->k(Landroid/view/View;)I
...
.method public setThumbResource(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->E:Landroid/support/v7/widget/ap;
