...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/an;-><init>(Landroid/view/View;Landroid/support/v7/widget/ap;)V

    iput-object v1, p0, Landroid/support/v7/widget/AppCompatImageButton;->a:Landroid/support/v7/widget/an;

    iget-object v1, p0, Landroid/support/v7/widget/AppCompatImageButton;->a:Landroid/support/v7/widget/an;

    invoke-virtual {v1, p2, p3}, Landroid/support/v7/widget/an;->a(Landroid/util/AttributeSet;I)V

    new-instance v1, Landroid/support/v7/widget/av;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/av;-><init>(Landroid/widget/ImageView;Landroid/support/v7/widget/ap;)V

    iput-object v1, p0, Landroid/support/v7/widget/AppCompatImageButton;->b:Landroid/support/v7/widget/av;

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatImageButton;->b:Landroid/support/v7/widget/av;
...
.method protected drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatImageButton;->a:Landroid/support/v7/widget/an;
