...
.method private static a(I)I
    ...
    sget v0, Landroid/support/v7/a/i;->notification_template_big_media_narrow:I

    :goto_0
    return v0

    :cond_0
    sget v0, Landroid/support/v7/a/i;->notification_template_big_media:I

    goto :goto_0
.end method

.method private static a(Landroid/content/Context;Landroid/support/v4/app/cg;)Landroid/widget/RemoteViews;
    .locals 4
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v14}, Landroid/support/v7/app/bn;->a(I)I
    ...
    invoke-static/range {v2 .. v13}, Landroid/support/v7/app/bn;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;

    move-result-object v4

    sget v2, Landroid/support/v7/a/g;->media_actions:I
    ...
    check-cast v2, Landroid/support/v4/app/cg;

    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/app/bn;->a(Landroid/content/Context;Landroid/support/v4/app/cg;)Landroid/widget/RemoteViews;

    move-result-object v2

    sget v5, Landroid/support/v7/a/g;->media_actions:I
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0, v2}, Landroid/support/v7/app/bn;->a(Landroid/content/Context;Landroid/support/v4/app/cg;)Landroid/widget/RemoteViews;

    move-result-object v2

    sget v7, Landroid/support/v7/a/g;->media_actions:I
...
.method public static a(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)V
    ...
    invoke-static/range {p1 .. p13}, Landroid/support/v7/app/bn;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/support/v4/app/bi;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)V
    ...
    invoke-static/range {p1 .. p14}, Landroid/support/v7/app/bn;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
