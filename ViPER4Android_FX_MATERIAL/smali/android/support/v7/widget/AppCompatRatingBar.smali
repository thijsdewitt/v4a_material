...
# instance fields
.field private a:Landroid/support/v7/widget/ax;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatRatingBar;->b:Landroid/support/v7/widget/ap;

    new-instance v0, Landroid/support/v7/widget/ax;

    iget-object v1, p0, Landroid/support/v7/widget/AppCompatRatingBar;->b:Landroid/support/v7/widget/ap;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ax;-><init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/ap;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatRatingBar;->a:Landroid/support/v7/widget/ax;

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatRatingBar;->a:Landroid/support/v7/widget/ax;
...
.method protected declared-synchronized onMeasure(II)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ax;->a()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p1, v1}, Landroid/support/v4/view/cf;->a(III)I
