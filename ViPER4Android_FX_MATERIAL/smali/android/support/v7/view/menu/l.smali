...
.field private c:Landroid/support/v7/app/ac;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ac;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/ad;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/ad;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/ad;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/ad;->a(Landroid/view/View;)Landroid/support/v7/app/ad;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/ad;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/ad;

    invoke-virtual {v1}, Landroid/support/v7/app/ad;->b()Landroid/support/v7/app/ac;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ac;

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ac;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/ac;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/ad;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/ad;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/app/ad;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/ad;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ac;

    invoke-virtual {v1}, Landroid/support/v7/app/ac;->getWindow()Landroid/view/Window;
