...
.field static final f:Landroid/support/design/widget/z;


# instance fields
.field private final A:Landroid/support/v4/view/bm;
...
.field private u:Landroid/support/design/widget/w;

.field private v:Z

.field private w:Landroid/support/v4/view/fj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/design/widget/z;
    ...
    sput-object v1, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/design/widget/z;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->A:Landroid/support/v4/view/bm;

    invoke-static {p1}, Landroid/support/design/widget/co;->a(Landroid/content/Context;)V

    sget-object v1, Landroid/support/design/j;->CoordinatorLayout:[I

    sget v2, Landroid/support/design/i;->Widget_Design_CoordinatorLayout:I

    invoke-virtual {p1, p2, v1, p3, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v1

    sget v2, Landroid/support/design/j;->CoordinatorLayout_keylines:I
    ...
    :cond_0
    sget v0, Landroid/support/design/j;->CoordinatorLayout_statusBarBackground:I
    ...
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/design/widget/z;
    ...
    invoke-direct {v1, p0, v6}, Landroid/support/design/widget/s;-><init>(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/r;)V

    invoke-interface {v0, p0, v1}, Landroid/support/design/widget/z;->a(Landroid/view/View;Landroid/support/v4/view/bn;)V

    :cond_1
    new-instance v0, Landroid/support/design/widget/u;

    invoke-direct {v0, p0, v6}, Landroid/support/design/widget/u;-><init>(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/r;)V
...
.method static synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
...
.method private a(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
    .locals 3
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Landroid/support/v4/view/fj;->b()I
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
...
.method private a(Landroid/view/MotionEvent;I)Z
    ...
    check-cast v4, Landroid/support/design/widget/v;

    invoke-virtual {v4}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    invoke-virtual {v4}, Landroid/support/design/widget/v;->e()Z

    move-result v7

    move-object/from16 v0, p0

    invoke-virtual {v4, v0, v12}, Landroid/support/design/widget/v;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method private b(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
    .locals 5

    invoke-virtual {p1}, Landroid/support/v4/view/fj;->e()Z
    ...
    invoke-static {v4}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p0, v4, v1}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
...
.method private b(Landroid/view/View;II)V
    ...
    iget v1, v0, Landroid/support/design/widget/v;->c:I
    ...
    iget v0, v0, Landroid/support/design/widget/v;->bottomMargin:I
...
.method private c(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;

    if-eqz v1, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;

    invoke-virtual {v2}, Landroid/support/v4/view/fj;->a()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/fj;->b()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/fj;->c()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/fj;->d()I
...
.method private e()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/v;->f()V
...
.method private f()V
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/view/View;)Landroid/support/design/widget/v;

    move-result-object v3

    invoke-virtual {v3, p0, v2}, Landroid/support/design/widget/v;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/design/widget/v;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/design/widget/v;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method a(Landroid/view/View;)Landroid/support/design/widget/v;
    .locals 6
    ...
    iget-boolean v1, v0, Landroid/support/design/widget/v;->b:Z
    ...
    const-class v1, Landroid/support/design/widget/t;
    ...
    :try_start_0
    invoke-interface {v2}, Landroid/support/design/widget/t;->a()Ljava/lang/Class;
    ...
    iput-boolean v1, v0, Landroid/support/design/widget/v;->b:Z
...
.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/v;
    .locals 1
    ...
    check-cast p1, Landroid/support/design/widget/v;

    invoke-direct {v0, p1}, Landroid/support/design/widget/v;-><init>(Landroid/support/design/widget/v;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/design/widget/v;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/design/widget/v;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/v;->d()Z
    ...
    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/v;->g:Landroid/view/View;

    if-eqz v1, :cond_1

    iget-object v0, v0, Landroid/support/design/widget/v;->g:Landroid/view/View;
    ...
    :cond_1
    iget v1, v0, Landroid/support/design/widget/v;->e:I

    if-ltz v1, :cond_2

    iget v0, v0, Landroid/support/design/widget/v;->e:I
...
.method a(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget v2, v0, Landroid/support/design/widget/v;->d:I
    ...
    iget v8, v0, Landroid/support/design/widget/v;->leftMargin:I
    ...
    iget v8, v0, Landroid/support/design/widget/v;->rightMargin:I
    ...
    iget v5, v0, Landroid/support/design/widget/v;->topMargin:I
...
.method a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/support/design/widget/de;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method a(Z)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->h(Landroid/view/View;)I
    ...
    check-cast v1, Landroid/support/design/widget/v;
    ...
    iget-object v8, v1, Landroid/support/design/widget/v;->h:Landroid/view/View;
    ...
    check-cast v2, Landroid/support/design/widget/v;

    invoke-virtual {v2}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/v;->i()Z

    move-result v9

    if-eqz v9, :cond_5

    invoke-virtual {v2}, Landroid/support/design/widget/v;->j()V
    ...
    invoke-virtual {v2, v1}, Landroid/support/design/widget/v;->b(Z)V
...
.method b()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/design/widget/w;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/design/widget/w;

    invoke-direct {v0, p0}, Landroid/support/design/widget/w;-><init>(Landroid/support/design/widget/CoordinatorLayout;)V

    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/design/widget/w;
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->u:Landroid/support/design/widget/w;
...
.method b(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;

    move-result-object v5

    if-eqz v5, :cond_1

    invoke-virtual {v1, p0, v0, p1}, Landroid/support/design/widget/v;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {v5, p0, v0, p1}, Landroid/support/design/widget/CoordinatorLayout$Behavior;->d(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
...
.method b(Landroid/view/View;I)V
    ...
    iget-object v4, v0, Landroid/support/design/widget/v;->g:Landroid/view/View;
...
.method b(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/design/widget/v;->a(Landroid/graphics/Rect;)V
...
.method c(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/v;->c()Landroid/graphics/Rect;
...
.method protected d()Landroid/support/design/widget/v;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/design/widget/v;-><init>(II)V
...
.method public d(Landroid/view/View;)Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {v0, p0, p1, v4}, Landroid/support/design/widget/v;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v1, v0, Landroid/support/design/widget/v;->a:Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    iget-object v0, v0, Landroid/support/design/widget/v;->a:Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method e(Landroid/view/View;)Z
    ...
    iget-object v3, v0, Landroid/support/design/widget/v;->g:Landroid/view/View;
    ...
    :cond_2
    invoke-virtual {v0, p0, p1, v5}, Landroid/support/design/widget/v;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/CoordinatorLayout;->d()Landroid/support/design/widget/v;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/util/AttributeSet;)Landroid/support/design/widget/v;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/v;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->A:Landroid/support/v4/view/bm;
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->w(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cf;->h(Landroid/view/View;)I
    ...
    iget-object v1, v0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;

    if-eqz v1, :cond_6

    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
    ...
    check-cast v8, Landroid/support/design/widget/v;

    const/4 v5, 0x0

    iget v1, v8, Landroid/support/design/widget/v;->e:I
    ...
    iget v2, v8, Landroid/support/design/widget/v;->c:I
    ...
    invoke-static {v3}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/fj;->a()I

    move-result v1

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;
    ...
    iget-object v4, v0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/view/fj;
    ...
    :goto_4
    invoke-virtual {v8}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    iget v2, v8, Landroid/support/design/widget/v;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v8, Landroid/support/design/widget/v;->rightMargin:I
    ...
    iget v2, v8, Landroid/support/design/widget/v;->topMargin:I

    add-int/2addr v1, v2

    iget v2, v8, Landroid/support/design/widget/v;->bottomMargin:I
    ...
    invoke-static {v3}, Landroid/support/v4/view/cf;->l(Landroid/view/View;)I

    move-result v1

    invoke-static {v12, v1}, Landroid/support/v4/view/cf;->a(II)I
    ...
    invoke-static {v14, v0, v1}, Landroid/support/v4/view/cf;->a(III)I
    ...
    invoke-static {v13, v0, v2}, Landroid/support/v4/view/cf;->a(III)I
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/v;->h()Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v4}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/view/View;)Landroid/support/design/widget/v;

    move-result-object v5

    invoke-virtual {v5}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
    ...
    check-cast v6, Landroid/support/design/widget/v;

    invoke-virtual {v6}, Landroid/support/design/widget/v;->b()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    invoke-virtual {v6, v1}, Landroid/support/design/widget/v;->a(Z)V
    ...
    :cond_0
    invoke-virtual {v6, v9}, Landroid/support/design/widget/v;->a(Z)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    :cond_1
    invoke-virtual {v0}, Landroid/support/design/widget/v;->g()V

    invoke-virtual {v0}, Landroid/support/design/widget/v;->j()V
