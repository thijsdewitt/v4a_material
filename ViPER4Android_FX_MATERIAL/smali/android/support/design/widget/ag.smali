...
.field private n:Landroid/support/design/widget/bs;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/az;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/ap;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/az;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/ag;->n:Landroid/support/design/widget/bs;

    iget-object v0, p0, Landroid/support/design/widget/ag;->n:Landroid/support/design/widget/bs;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/bs;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/bs;->a([ILandroid/view/animation/Animation;)V
...
.method a(F)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/ag;->a:Landroid/support/design/widget/ay;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/ag;->d:Landroid/support/design/widget/l;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/ag;->a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/l;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/ag;->d:Landroid/support/design/widget/l;

    const/4 v0, 0x3

    new-array v0, v0, [Landroid/graphics/drawable/Drawable;

    iget-object v1, p0, Landroid/support/design/widget/ag;->d:Landroid/support/design/widget/l;
    ...
    iget-object v1, p0, Landroid/support/design/widget/ag;->k:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v3, p0, Landroid/support/design/widget/ag;->l:Landroid/support/design/widget/az;
    ...
    iput-object v0, p0, Landroid/support/design/widget/ag;->a:Landroid/support/design/widget/ay;

    iget-object v0, p0, Landroid/support/design/widget/ag;->a:Landroid/support/design/widget/ay;

    invoke-virtual {v0, v7}, Landroid/support/design/widget/ay;->a(Z)V

    iget-object v0, p0, Landroid/support/design/widget/ag;->l:Landroid/support/design/widget/az;

    iget-object v1, p0, Landroid/support/design/widget/ag;->a:Landroid/support/design/widget/ay;
...
.method a(Landroid/support/design/widget/ar;Z)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/ag;->k:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method a([I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/bs;->a([I)V
...
.method b()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/bs;->b()V
