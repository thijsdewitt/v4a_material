...
.field private e:Landroid/support/design/widget/aw;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/design/j;->NavigationView:[I

    sget v1, Landroid/support/design/i;->Widget_Design_NavigationView:I

    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v6

    sget v0, Landroid/support/design/j;->NavigationView_android_background:I
    ...
    sget v0, Landroid/support/design/j;->NavigationView_elevation:I
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/cf;->g(Landroid/view/View;F)V

    :cond_0
    sget v0, Landroid/support/design/j;->NavigationView_android_fitsSystemWindows:I

    invoke-virtual {v6, v0, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    invoke-static {p0, v0}, Landroid/support/v4/view/cf;->a(Landroid/view/View;Z)V

    sget v0, Landroid/support/design/j;->NavigationView_android_maxWidth:I
    ...
    sget v0, Landroid/support/design/j;->NavigationView_itemIconTint:I
    ...
    :goto_0
    sget v1, Landroid/support/design/j;->NavigationView_itemTextAppearance:I
    ...
    sget v7, Landroid/support/design/j;->NavigationView_itemTextColor:I
    ...
    sget v5, Landroid/support/design/j;->NavigationView_itemTextColor:I
    ...
    :cond_2
    sget v7, Landroid/support/design/j;->NavigationView_itemBackground:I
    ...
    new-instance v9, Landroid/support/design/widget/av;

    invoke-direct {v9, p0}, Landroid/support/design/widget/av;-><init>(Landroid/support/design/widget/NavigationView;)V

    invoke-virtual {v8, v9}, Landroid/support/design/internal/a;->a(Landroid/support/v7/view/menu/j;)V
    ...
    invoke-virtual {v4, p1, v8}, Landroid/support/design/internal/b;->a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/internal/a;->a(Landroid/support/v7/view/menu/x;)V

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->d:Landroid/support/design/internal/b;

    invoke-virtual {v0, p0}, Landroid/support/design/internal/b;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/z;
    ...
    sget v0, Landroid/support/design/j;->NavigationView_menu:I
    ...
    :cond_4
    sget v0, Landroid/support/design/j;->NavigationView_headerLayout:I
...
.method static synthetic a(Landroid/support/design/widget/NavigationView;)Landroid/support/design/widget/aw;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->e:Landroid/support/design/widget/aw;
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/design/internal/b;->a(Landroid/support/v7/view/menu/m;)V
...
.method public setNavigationItemSelectedListener(Landroid/support/design/widget/aw;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/NavigationView;->e:Landroid/support/design/widget/aw;
