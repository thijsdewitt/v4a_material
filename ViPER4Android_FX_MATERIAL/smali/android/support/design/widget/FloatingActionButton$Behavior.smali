...
# instance fields
.field private b:Landroid/support/design/widget/cp;
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    invoke-static {p1, p2, v0}, Landroid/support/design/widget/de;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p3, v3, v1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ae;Z)V
    ...
    :cond_3
    invoke-static {p3, v3, v1}, Landroid/support/design/widget/FloatingActionButton;->b(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ae;Z)V
...
.method private d(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)V
    ...
    :cond_0
    invoke-static {p2}, Landroid/support/v4/view/cf;->p(Landroid/view/View;)F

    move-result v1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/cp;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/cp;

    invoke-virtual {v2}, Landroid/support/design/widget/cp;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/cp;->e()V
    ...
    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/cp;
    ...
    new-instance v3, Landroid/support/design/widget/ad;

    invoke-direct {v3, p0, p2}, Landroid/support/design/widget/ad;-><init>(Landroid/support/design/widget/FloatingActionButton$Behavior;Landroid/support/design/widget/FloatingActionButton;)V
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/design/widget/cp;->a(FF)V

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/cp;

    invoke-virtual {v1}, Landroid/support/design/widget/cp;->a()V
    ...
    :cond_3
    invoke-static {p2, v0}, Landroid/support/v4/view/cf;->b(Landroid/view/View;F)V
