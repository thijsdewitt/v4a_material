...
.field private r:Landroid/support/design/widget/cp;

.field private s:Landroid/support/design/widget/g;

.field private t:I

.field private u:Landroid/support/v4/view/fj;
...
.method static synthetic a(Landroid/view/View;)Landroid/support/design/widget/dk;
    .locals 1

    invoke-static {p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->d(Landroid/view/View;)Landroid/support/design/widget/dk;
...
.method static synthetic a(Landroid/support/design/widget/CollapsingToolbarLayout;)Landroid/support/v4/view/fj;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->u:Landroid/support/v4/view/fj;

    return-object v0
.end method

.method static synthetic a(Landroid/support/design/widget/CollapsingToolbarLayout;Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->a(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
...
.method private a(Landroid/support/v4/view/fj;)Landroid/support/v4/view/fj;
    ...
    iput-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->u:Landroid/support/v4/view/fj;

    invoke-virtual {p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->requestLayout()V

    :cond_0
    invoke-virtual {p1}, Landroid/support/v4/view/fj;->f()Landroid/support/v4/view/fj;
...
.method private a(I)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->r:Landroid/support/design/widget/cp;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->r:Landroid/support/design/widget/cp;

    iget-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->r:Landroid/support/design/widget/cp;

    const/16 v1, 0x258

    invoke-virtual {v0, v1}, Landroid/support/design/widget/cp;->a(I)V

    iget-object v1, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->r:Landroid/support/design/widget/cp;
    ...
    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/design/widget/cp;->a(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/cp;->a(Landroid/support/design/widget/cu;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/design/widget/cp;->a(II)V
...
.method private static d(Landroid/view/View;)Landroid/support/design/widget/dk;
    .locals 2
    ...
    check-cast v0, Landroid/support/design/widget/dk;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/design/widget/dk;

    invoke-direct {v0, p0}, Landroid/support/design/widget/dk;-><init>(Landroid/view/View;)V
...
.method private setScrimAlpha(I)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/cf;->d(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p0, v3, v4}, Landroid/support/design/widget/de;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/CollapsingToolbarLayout;->u:Landroid/support/v4/view/fj;

    if-eqz v3, :cond_1

    invoke-static {v1}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/fj;->b()I
    ...
    invoke-static {v1, v3}, Landroid/support/v4/view/cf;->f(Landroid/view/View;I)V

    :cond_1
    invoke-static {v1}, Landroid/support/design/widget/CollapsingToolbarLayout;->d(Landroid/view/View;)Landroid/support/design/widget/dk;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/design/widget/dk;->a()V
