...
.field private d:Landroid/support/design/widget/cp;
...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    :cond_0
    :goto_1
    invoke-static {v5}, Landroid/support/v4/view/cf;->x(Landroid/view/View;)Z
...
.method private b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;

    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;

    sget-object v2, Landroid/support/design/widget/a;->e:Landroid/view/animation/Interpolator;

    invoke-virtual {v1, v2}, Landroid/support/design/widget/cp;->a(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/cp;->a(Landroid/support/design/widget/cu;)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;
    ...
    invoke-virtual {v2, v1}, Landroid/support/design/widget/cp;->a(I)V

    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/cp;

    invoke-virtual {v1, v0, p3}, Landroid/support/design/widget/cp;->a(II)V
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    invoke-static {v0, v1, v2}, Landroid/support/design/widget/au;->a(III)I
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    invoke-static {p3, p4, p5}, Landroid/support/design/widget/au;->a(III)I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    invoke-static {v0, v3, v1}, Landroid/support/design/widget/au;->a(III)I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIII)Z
    ...
    iget v0, v0, Landroid/support/design/widget/v;->height:I
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    invoke-static {v6}, Landroid/support/v4/view/cf;->r(Landroid/view/View;)I
