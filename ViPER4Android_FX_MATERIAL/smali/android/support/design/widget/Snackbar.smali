...
.field private f:Landroid/support/design/widget/bl;

.field private final g:Landroid/view/accessibility/AccessibilityManager;

.field private final h:Landroid/support/design/widget/bq;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2}, Landroid/support/design/widget/ba;-><init>()V
...
.method private constructor <init>(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/bc;-><init>(Landroid/support/design/widget/Snackbar;)V

    iput-object v0, p0, Landroid/support/design/widget/Snackbar;->h:Landroid/support/design/widget/bq;
    ...
    invoke-static {v0}, Landroid/support/design/widget/co;->a(Landroid/content/Context;)V
...
.method static synthetic a(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/bq;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->h:Landroid/support/design/widget/bq;
...
.method private c(I)V
    ...
    invoke-static {}, Landroid/support/design/widget/bo;->a()Landroid/support/design/widget/bo;

    move-result-object v0

    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->h:Landroid/support/design/widget/bq;

    invoke-virtual {v0, v1, p1}, Landroid/support/design/widget/bo;->a(Landroid/support/design/widget/bq;I)V
...
.method static synthetic c(Landroid/support/design/widget/Snackbar;)Z
    ...
    invoke-direct {p0}, Landroid/support/design/widget/Snackbar;->g()Z
...
.method private d(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ep;->c(F)Landroid/support/v4/view/ep;

    move-result-object v0

    sget-object v1, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ep;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ep;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/design/widget/bj;-><init>(Landroid/support/design/widget/Snackbar;I)V
...
.method private e()V
    ...
    invoke-direct {v1, p0}, Landroid/support/design/widget/bh;-><init>(Landroid/support/design/widget/Snackbar;)V
...
.method private e(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/bo;->a(Landroid/support/design/widget/bq;)V

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->f:Landroid/support/design/widget/bl;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->f:Landroid/support/design/widget/bl;

    invoke-virtual {v0, p0, p1}, Landroid/support/design/widget/bl;->a(Landroid/support/design/widget/Snackbar;I)V
...
.method private f()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/bo;->b(Landroid/support/design/widget/bq;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/design/widget/bl;->a(Landroid/support/design/widget/Snackbar;)V
...
.method public a()V
    ...
    iget-object v2, p0, Landroid/support/design/widget/Snackbar;->h:Landroid/support/design/widget/bq;

    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/bo;->a(ILandroid/support/design/widget/bq;)V
...
.method public b()Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/bo;->e(Landroid/support/design/widget/bq;)Z
...
.method final c()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/bk;->a(F)V

    const v2, 0x3f19999a    # 0.6f

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bk;->b(F)V

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bk;->a(I)V

    new-instance v2, Landroid/support/design/widget/bd;

    invoke-direct {v2, p0}, Landroid/support/design/widget/bd;-><init>(Landroid/support/design/widget/Snackbar;)V

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bk;->a(Landroid/support/design/widget/bw;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/Snackbar$SnackbarLayout;->setOnAttachStateChangeListener(Landroid/support/design/widget/bm;)V

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->d:Landroid/support/design/widget/Snackbar$SnackbarLayout;

    invoke-static {v0}, Landroid/support/v4/view/cf;->F(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/Snackbar$SnackbarLayout;->setOnLayoutChangeListener(Landroid/support/design/widget/bn;)V
