...
.field private f:Landroid/support/design/widget/bm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/j;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/j;->SnackbarLayout_android_maxWidth:I
    ...
    sget v1, Landroid/support/design/j;->SnackbarLayout_maxActionInlineWidth:I
    ...
    sget v1, Landroid/support/design/j;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/cf;->g(Landroid/view/View;F)V
    ...
    sget v1, Landroid/support/design/g;->design_layout_snackbar_include:I

    invoke-virtual {v0, v1, p0}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    invoke-static {p0, v3}, Landroid/support/v4/view/cf;->e(Landroid/view/View;I)V

    invoke-static {p0, v3}, Landroid/support/v4/view/cf;->c(Landroid/view/View;I)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/cf;->A(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/cf;->m(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/view/cf;->n(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/view/cf;->b(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ep;->b(J)Landroid/support/v4/view/ep;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bm;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bm;

    invoke-interface {v0, p0}, Landroid/support/design/widget/bm;->a(Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0, p0}, Landroid/support/design/widget/bm;->b(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bn;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/bn;->a(Landroid/view/View;IIII)V
...
.method protected onMeasure(II)V
    ...
    sget v1, Landroid/support/design/e;->design_snackbar_padding_vertical_2lines:I
    ...
    sget v4, Landroid/support/design/e;->design_snackbar_padding_vertical:I
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/bm;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bm;

    return-void
.end method

.method setOnLayoutChangeListener(Landroid/support/design/widget/bn;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bn;
