...
# instance fields
.field private d:Landroid/support/v4/content/f;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v4/content/f;
    ...
    :try_start_1
    invoke-static {p0, p1}, Landroid/support/v4/content/FileProvider;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v4/content/f;
    :try_end_1
...
.method private static b(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v4/content/f;
    .locals 9
    ...
    new-instance v2, Landroid/support/v4/content/g;

    invoke-direct {v2, p1}, Landroid/support/v4/content/g;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v4, v0}, Landroid/support/v4/content/g;->a(Ljava/lang/String;Ljava/io/File;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/content/FileProvider;->d:Landroid/support/v4/content/f;

    invoke-interface {v1, p1}, Landroid/support/v4/content/f;->a(Landroid/net/Uri;)Ljava/io/File;
