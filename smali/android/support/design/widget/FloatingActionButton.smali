...
.field private j:Landroid/support/design/widget/ap;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0, v3}, Landroid/support/v7/widget/av;-><init>(Landroid/widget/ImageView;Landroid/support/v7/widget/ap;)V

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->i:Landroid/support/v7/widget/av;

    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->i:Landroid/support/v7/widget/av;

    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/av;->a(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/ap;
    ...
    invoke-virtual {v0, v3, v4, v5, v6}, Landroid/support/design/widget/ap;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/ap;

    move-result-object v0

    invoke-virtual {v0, v1}, Landroid/support/design/widget/ap;->c(F)V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/ap;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/design/widget/ap;->d(F)V

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/ap;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/design/widget/ap;->g()V
...
.method private a()Landroid/support/design/widget/ap;
    .locals 3
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/design/widget/af;-><init>(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ac;)V

    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/as;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/az;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/am;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/az;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/ag;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/az;)V

    goto :goto_0
.end method

.method private a(Landroid/support/design/widget/ae;)Landroid/support/design/widget/ar;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/design/widget/ac;-><init>(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ae;)V
...
.method static synthetic a(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ae;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/FloatingActionButton;->b(Landroid/support/design/widget/ae;Z)V

    return-void
.end method

.method private a(Landroid/support/design/widget/ae;Z)V
    .locals 2
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/ae;)Landroid/support/design/widget/ar;

    move-result-object v1

    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/ap;->b(Landroid/support/design/widget/ar;Z)V
...
.method static synthetic b(Landroid/support/design/widget/FloatingActionButton;Landroid/support/design/widget/ae;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/ae;Z)V

    return-void
.end method

.method private b(Landroid/support/design/widget/ae;Z)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p2}, Landroid/support/design/widget/ap;->a(Landroid/support/design/widget/ar;Z)V
...
.method private getImpl()Landroid/support/design/widget/ap;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->j:Landroid/support/design/widget/ap;

    if-nez v0, :cond_0

    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->a()Landroid/support/design/widget/ap;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->j:Landroid/support/design/widget/ap;
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ap;->a([I)V
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ap;->f()Landroid/graphics/drawable/Drawable;
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ap;->b()V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ap;->h()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ap;->i()V
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ap;->a(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ap;->a(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCompatElevation(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ap;->c(F)V
...
.method public setRippleColor(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/ap;->a(I)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/ap;->c()V
