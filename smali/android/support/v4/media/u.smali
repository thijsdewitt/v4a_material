...
.method constructor <init>(Landroid/support/v4/media/n;Landroid/support/v4/media/k;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/u;->b:Landroid/support/v4/media/n;

    iput-object p2, p0, Landroid/support/v4/media/u;->a:Landroid/support/v4/media/k;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/u;->a:Landroid/support/v4/media/k;

    invoke-interface {v0}, Landroid/support/v4/media/k;->a()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/u;->b:Landroid/support/v4/media/n;
