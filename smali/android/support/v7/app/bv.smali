...
# static fields
.field private static d:Landroid/support/v7/app/bv;
...
.method static a()Landroid/support/v7/app/bv;
    .locals 1

    sget-object v0, Landroid/support/v7/app/bv;->d:Landroid/support/v7/app/bv;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/app/bv;

    invoke-direct {v0}, Landroid/support/v7/app/bv;-><init>()V

    sput-object v0, Landroid/support/v7/app/bv;->d:Landroid/support/v7/app/bv;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/bv;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/bv;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/bv;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/bv;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/app/bv;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/bv;->a:J
